...
nmap `w <Plug>(easymotion-overwin-w) let Vundle manage Vundle, required
...
nnoremap <SNR>13_: :=v:count ? v:count : ''
vmap <BS> "-d
vmap <D-x> "*d
vmap <D-c> "*y
vmap <D-v> "-d"*P
...
silent only
cd ~/FAC8/9week/toDoList
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2 webpack.config.js
badd +8 package.json
badd +15 index.js
badd +12 List.js
badd +28 example.js
